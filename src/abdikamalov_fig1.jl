...
function plot_data(dx_at,dx_ab,dx_bt,dx_bb,dx_ct,dx_cb)
    p=plot(r,[dx_ct],fillrange=dx_cb,label="0.2",ylims=(-15,15),xlabel="radius",ylabel="height")
    plot!(r,dx_bt,fillrange=dx_bb,label="0.2")
    plot!(r,dx_at,fillrange=dx_ab, label="0.1")
    return p
end  
#a=0.0 α13=0.35
...
plot_horizon!(m9_a, color = :black)

plot(p1,p2,p3,p4,p5,p6,p7,p8,p9,layout=@layout[p1 p2 p3; p4 p5 p6; p7 p8 p9],title=["a=0.0 α13=0.35" "a=0.0 α13=0.0" "a=0.0 α13=-0.35" "a=0.8 α13=0.35" "a=0.8 α13=0.0" "a=0.8 α13=-0.35" "a=0.998 α13=0.35" "a=0.998 α13=0.0" "a=0.998 α13=-0.35"],plot_title="Abdikamalov Figure 1",size=(1000,1000))
